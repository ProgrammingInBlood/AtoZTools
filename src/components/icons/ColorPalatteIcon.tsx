...
function ColorPalatteIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      ...
      <g>
        <g>
          <path d="M507.649,208.842H331.881l155.88,155.993C503.299,331.804,512,294.92,512,256    C512,239.888,510.496,224.129,507.649,208.842z" />
        </g>
      </g>
      <g>
        <g>
...
export default ColorPalatteIcon;
