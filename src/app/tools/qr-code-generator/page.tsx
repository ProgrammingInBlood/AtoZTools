...
function QrCodePage() {
  ...
  return (
    <>
      {/* QR Code Settings */}
      <div className="p-5 rounded-xl bg-neutral-800 mt-8 flex flex-col justify-center items-center w-full">
        <QRCode
      ...
      <div className="w-full grid gap-4 md:grid-cols-2 py-4 md:px-4 space-y-6 md:space-y-0">
